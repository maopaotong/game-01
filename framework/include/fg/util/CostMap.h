...
namespace fog
{
    ...
    public:
        ...
        std::vector<CellKey> findPath(CellKey start, CellKey end)
        {
            std::vector<Vector2> path = findPathInternal(start.first, start.second, end.first, end.second);
            std::vector<CellKey> cellPath;
        ...
        std::vector<Ogre::Vector2> findNormPath(CellKey start, CellKey end)
        {
            return findPathInternal(start.first, start.second, end.first, end.second);
        }
        std::vector<Ogre::Vector2> findPathInternal(int startX, int startY, int endX, int endY)
        {
